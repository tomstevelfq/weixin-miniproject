// pages/healthAnalyse/healthAnalyse.js
var app=getApp()
Page({
  ...
  click:function(e){
    ...
    app.globalData.analyseContent = this.data.list[id].contents
    app.globalData.analyseTitle = this.data.list[id].title
    wx.navigateTo({
      url: 'analyse/analyse',
    })
  },
  ...
  search:function(){
    ...
    var that = this
    wx.request({
      url: "http://127.0.0.1:8080/getAnalyses",
      method: "POST",
      data: {
